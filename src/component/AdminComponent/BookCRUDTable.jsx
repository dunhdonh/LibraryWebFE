                ...
                <table className="min-w-full bg-white">
                    <thead className="bg-gray-100">
                        <tr className="text-left">
                            ...
                            <th className="p-2 min-w-48">Tên sách</th>
                            <th className="p-2 min-w-24">Tác giả</th>
                            <th className="p-2 min-w-24">Thể loại</th>
                            <th className="p-2 min-w-24">Số lượng</th>
                            <th className="p-2 min-w-28">Lượt mượn</th>
                            <th className="p-2 min-w-20"></th>
                        </tr>
                    </thead>
                    <tbody>
                        {filteredBooks.map((book) => (
                            <tr key={book._id} className="text-left border-b">
                                <td className="p-2 ">
                                ...
                                <td className="p-2 text-center">{book.stock}</td>
                                <td className="p-2 text-center">{book.borrowCount}</td>
